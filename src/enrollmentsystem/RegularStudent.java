 ...
 * @author ACER
 */
public class RegularStudent extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegularStudent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
